    ...
    public String addFile(@RequestParam(value = "fileUpload") MultipartFile file,
        ...
        User user = userService.getUser(userService.getCurrentUsername());
            ...
            if(!file.isEmpty()){
                ...
                if(file.getSize() > ConstantsUtils.FILE_SIZE){
                    redirectAttributes.addFlashAttribute
                            ("errorMessage","The file exceeds allowed size " + ConstantsUtils.FILE_SIZE + ". Please try again");
                    return redirectPath;
                }

                if(fileService.findFile(file.getOriginalFilename()) != null){
                    redirectAttributes.addFlashAttribute("errorMessage","The file already exists. Please choice another name.");
                    return redirectPath;
                }
